			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-4 form-group" style="margin: auto;">
						...
						<input type="button" class="btn btn-primary" name="hospital_info_add" id="hospital_info_add" value="추가하기" style="border-radius: 50px; width: 110px; margin: auto; text-align: center; float: right; color: white;">
					</div>
				</div>
			</div>
		</section>
