		...
		<section class="inner-page">
			<div class="container">
					...
					<div class="col-md-4 form-group mt-3"style="margin: auto;">
						...
						<textarea class="form-control" name="message" rows="3" placeholder="이력을 입력해주세요."></textarea>
						<div class="validate"></div>
					</div>
					<div class="col-md-4 form-group mt-3"style="margin: auto;">
						<label for="text">학력</label>
						<textarea class="form-control" name="message" rows="3" placeholder="학력을 입력해주세요."></textarea>
						<div class="validate"></div>
					</div>
					<br />
					<br>
