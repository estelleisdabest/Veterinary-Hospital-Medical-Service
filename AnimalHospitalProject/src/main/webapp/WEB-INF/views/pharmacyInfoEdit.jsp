		...
		<section class="breadcrumbs">
			<div class="container">
				...
				<div class="section-title">
					<h2 style="font-weight: bold; font-size: 30px;">약국 정보 수정</h2>
					<br />
					<p>
						약국 정보 표시 화면에 표시할 약국 정보를 수정하는 화면입니다.<br> <b style="color: red;">위도, 경도</b> 값을 정확히 입력해주세요.
					</p>
				</div>
			</div>
		</section>
		<!-- End Breadcrumbs Section -->
		<form action="pharmacyEditOk" method="post" id="pharmacyEditSubmit">
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-md-4 form-group mt-3">
							...
							<input type="text" class="form-control" name="pharmacy_name" id="pharmacy_name" placeholder="약국 이름을 입력해주세요">
					...
					<div class="row">
						...
						<div class="col-md-4 form-group mt-3">
							...
							<div class="wrap">
								<input type="text" class="form-control" readonly="readonly" id="input_pharmacy_address" name="input_pharmacy_address" placeholder="주소찾기 버튼을 눌러주세요">
								&nbsp;
					...
					<div class="row">
						...
						<div class="col-md-4 form-group" style="margin: auto;">
							...
							<input type="button" class="btn btn-primary" name="hospital_info_edit" id="hospital_info_edit" value="수정하기"
								style="border-radius: 50px; width: 110px; margin: auto; text-align: center; float: right; color: white;">
						</div>
					</div>
				</div>
