  ...
  <main id="main">
	...
	<br />
		<div class="section-title">
          ...
          <br />
			<p>
				약국 정보 표시 화면에 표시할 약국 정보를 수정하는 화면입니다.<br>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-4 form-group mt-3">
						<label for="name">약국 이름</label> <input type="text"
							class="form-control" name="pharmacy_name" id="pharmacy_name">
						<div class="validate"></div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-4 form-group mt-3">
						...
						<div class="wrap">
							...
							<input type="button" name="pharmacy_address" id="pharmacy_address" onclick="sample4_execDaumPostcode()" class="btn btn-primary btn-sm" value="주소찾기" style="border-radius: 50px; width: 110px; margin: auto; text-align: center; float: right; color: white;">
						</div>
						<div class="validate"></div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-4 form-group" style="margin: auto;">
						...
						<input type="button" class="btn btn-primary" name="hospital_info_edit" id="hospital_info_edit" value="수정하기" onclick="location='/hosMap'" style="border-radius: 50px; width: 110px; margin: auto; text-align: center; float: right; color: white;">
					</div>
				</div>
