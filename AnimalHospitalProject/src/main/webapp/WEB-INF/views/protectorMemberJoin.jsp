			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-4 form-group mt-3">
						...
						<div class="validate" id="confirm_emailUser_val"></div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-4 form-group mt-3">
				...
				<div class="row">
					...
					<div class="col-md-4 form-group mt-3">
						...
						<div class="validate" id="password_reconfirm_val"></div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-4 form-group mt-3">
					...
					<div class="col-md-4 form-group mt-3">
						...
						<div class="validate"  id="protector_name_val"></div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-4 form-group mt-3">
					...
					<div class="col-md-4 form-group mt-3">
						...
						<div class="validate" id="protector_gender_val"></div>
					</div>
				</div>
				<div class="row" id="protector_yearmonthday" style="margin: auto; width: 800px; height: 100px; display: flex; justify-content: center;">
					...
					<div id="protector_monthDiv" class="col-md-2 form-group mt-3">
						...
						<div class="validate" id="protector_month_val"></div>
					</div>
					&nbsp;
				...
				<div class="row">
					...
					<div class="col-md-6 form-group mt-3">
						...
						<div class="validate" id="protector_address_val"></div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-4 form-group mt-3">
					...
					<div class="col-md-6 form-group mt-3">
						...
						<div class="validate" id="protector_phoneNumber_val"></div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-4 form-group mt-3">
...
$('#protector_phoneNumber').on('input',function(){
	if($('#protector_phoneNumber').val() !=''){
		...
		$('#protector_phoneNumber_warning').remove();
	}
})
...
$('#confirm_emailUser').on('input',function(){
	if($('#confirm_emailUser').val() !=''){
		...
		$('#confirm_emailUser_warning').remove();
	}
})
</script>
