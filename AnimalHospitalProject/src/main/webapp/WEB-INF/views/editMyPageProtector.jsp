		...
		<section class="breadcrumbs">
			<div class="container">
				...
				<div class="section-title">
					...
					<p style="font-size: 11pt; color: red; display: inline;">이름, ID, 생년월일</p>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-4 form-group mt-3">
						...
						<div class="wrap">
							<input type="text" class="form-control" name="phone" id="phoneNum" placeholder="수정할 전화번호를 입력해주세요." maxlength="13"
								data-rule="age" data-msg="필수입력 항목입니다.">
							&nbsp;
							<input type="button" value="인증번호" class="btn btn-primary"
				...
				<div class="row">
					...
					<div class="col-md-4 form-group mt-3">
						...
						<input type="number" class="form-control" name="confirm_certificationNumber" id="cNum" placeholder="인증번호를 입력해주세요."
				...
				<div class="row">
					...
					<div class="col-md-4 form-group mt-3">
						...
						<div class="wrap">
							...
							&nbsp;
							<input type="button" name="address_kakao" id="address_kakao" class="btn btn-primary" value="주소찾기"
								style="border-radius: 50px; width: 110px; margin: auto; text-align: center; float: right; color: white;">
						</div>
				...
				<div class="row">
					...
					<div class="col-md-4 form-group mt-3">
						...
						<input type="text" class="form-control" name="address2" id="address2" placeholder="수정할 상세주소를 입력해주세요.">
				...
				<div class="row">
					...
					<div class="col-md-4 form-group" style="margin: auto;">
						...
						<input type="submit" class="btn btn-primary" name="updateMyInfo" id="updateMyInfo" value="수정하기"
							style="border-radius: 50px; width: 110px; margin: auto; text-align: center; float: right; color: white;">
					</div>
				</div>
			</div>
