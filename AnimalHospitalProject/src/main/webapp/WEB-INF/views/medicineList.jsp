...
<body>
	...
	<main id="main">
		...
		<div class="col-md-8" style="margin: auto;">
			...
			<button class="btn btn-primary" type="submit" style="margin-left: 230px">처방약 수정</button>
			<button class="btn btn-primary" type="submit" style="margin-left: 420px">처방약 삭제</button>
		</div>
	</main>
	<!-- End #main -->
