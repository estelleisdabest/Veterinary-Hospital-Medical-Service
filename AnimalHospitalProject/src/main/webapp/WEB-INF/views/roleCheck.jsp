      ...
      <div>
		...
		<div class="row">
       		...
       		<div class="col-md-8 form-group">
      			<input type="button" class="btn btn-secondary" name="move_pre_page" id="move_pre_page" value="이전페이지" onclick="location='/signin'" style="width: 110px;margin: auto;text-align: center;color: white; border-radius: 50px;">
   				<input type="button" class="btn btn-primary" name="join_membership" id="join_membership" value="회원가입" style="width: 110px;margin: auto;text-align: center;float: right;color: white; border-radius: 50px;">
    		</div>
      	</div>
    </section>
  </main><!-- End #main -->
